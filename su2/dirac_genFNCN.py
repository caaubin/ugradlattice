...
def gen_dirac(m, spaceLength, timeLength, r=1.):
# def genDirac():
...
# 		U = pickle.load(open('Configs/Ucold_2_2_2_2','rb'), encoding='latin1')
	U = pickle.load(open('/Users/anthonygirardi/argpars/quSU2_b2.4_2_2.999','rb'), encoding='latin1')
	...
	for i in range(0,rowCol,8):# runs over xyzt, 0 to rowCol=2048 in steps of 8
		ec = 0
...
# 	gen_dirac(U,m,spaceLength,timeLength,r)
